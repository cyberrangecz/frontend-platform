...
export class TopologyExample {
    ...
    presetLinks = signal<GraphNodeLink[]>([
        ...
        {
            id: 10,
            source: this.presetNodes()[3],
            target: this.presetNodes()[10],
        }, // AccessSwitch1 -> DeviceA2

        // Access2 to Devices
        {
            id: 11,
            source: this.presetNodes()[4],
            target: this.presetNodes()[11],
        }, // AccessSwitch2 -> DeviceA3
        {
            id: 12,
            source: this.presetNodes()[4],
            target: this.presetNodes()[12],
        }, // AccessSwitch2 -> DeviceA4

        // Access3 to Devices
        {
            id: 13,
            source: this.presetNodes()[5],
            target: this.presetNodes()[13],
        }, // AccessSwitch3 -> DeviceA5
        {
            id: 14,
            source: this.presetNodes()[5],
            target: this.presetNodes()[14],
        }, // AccessSwitch3 -> DeviceA6
    ]);
}
