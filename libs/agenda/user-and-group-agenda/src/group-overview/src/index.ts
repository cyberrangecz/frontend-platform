/*
 * Public API Surface of entry point user-and-group-agenda/group-overview
 */
...
export { GroupTitleResolver } from './services/resolvers/group-title-resolver.service';
export { GroupBreadcrumbResolver } from './services/resolvers/group-breadcrumb-resolver.service';
