/**
 * Service handling editing of training-training definition's levels and related operations.
...
export abstract class MitreTechniquesService {
    protected mitreTechniquesSubject$: BehaviorSubject<MitreTechnique[]> =
        new BehaviorSubject([]);
