...
} from '../../../../services/adaptive-run/access-phase/adaptive-run-access-phase.service';
import {
    AdaptiveRunAccessPhaseConcreteService
} from '../../../../services/adaptive-run/access-phase/adaptive-run-access-phase-concrete.service';
import {GenericSandboxLevelComponent} from "@crczp/training-agenda/run-detail";
