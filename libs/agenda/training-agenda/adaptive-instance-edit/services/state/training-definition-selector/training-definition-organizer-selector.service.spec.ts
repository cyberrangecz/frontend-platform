...
import {AdaptiveDefinitionApiService} from 'libs/api/training-api/src';
import {TrainingDefinitionInfo} from 'libs/model/training-model/src';
...
} from './adaptive-definition-organizer-select-concrete.service';
