...
export * from './definition/training/training-definition-detail-title-resolver.service';
...
export * from './instance/training/training-instance-title-resolver.service';
