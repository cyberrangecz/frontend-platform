...
import {Pool, SandboxInstance} from 'libs/model/sandbox-model/src';
import {TrainingInstanceApi} from 'libs/api/training-api/src';
import {TrainingInstance} from 'libs/model/training-model/src';
