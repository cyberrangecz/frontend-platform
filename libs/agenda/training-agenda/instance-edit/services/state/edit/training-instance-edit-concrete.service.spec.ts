...
import {PoolApi, SandboxDefinitionApi, SandboxInstanceApi} from 'libs/api/sandbox-api/src';
import {TrainingDefinitionApi, TrainingInstanceApi} from 'libs/api/training-api/src';
import {TrainingDefinition, TrainingInstance} from 'libs/model/training-model/src';
...
} from '../../../../../internal/testing/testing-commons.spec';
...
import {TrainingAgendaContext} from '../../../../../internal/services/context/training-agenda-context.service';
import {TrainingInstanceEditConcreteService} from './training-instance-edit-concrete.service';
import {Pool, SandboxDefinition} from 'libs/model/sandbox-model/src';
...
describe('TrainingInstanceEditConcreteService', () => {
    ...
    it('should save existing training instance', (done) => {
        ...
        trainingDefinitionApiSpy.getAllForOrganizer.and.returnValue(
            asyncData(createTrainingDefinitionsPaginatedMock()),
        );
