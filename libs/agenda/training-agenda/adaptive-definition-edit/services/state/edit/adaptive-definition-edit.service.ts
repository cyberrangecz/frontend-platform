...
export abstract class AdaptiveDefinitionEditService {
     ...
     */
    abstract hasUnsavedChanges$: Observable<boolean>;
    protected trainingDefinitionSubject$: BehaviorSubject<TrainingDefinition> =
        new BehaviorSubject(null);
    /**
     * Currently edited training definition
     */
    trainingDefinition$: Observable<TrainingDefinition> =
        this.trainingDefinitionSubject$
            .asObservable()
    ...
    protected formValidSubject: BehaviorSubject<boolean> = new BehaviorSubject(
        false,
    );
    protected definitionValidSubject$: BehaviorSubject<boolean> =
