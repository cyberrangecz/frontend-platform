...
import {AbstractPhaseTypeEnum, AdaptiveTask, Phase, QuestionnaireTypeEnum, TrainingPhase} from '@crczp/training-model';
...
export abstract class PhaseEditService {
    ...
    protected activeTasksSubject$: BehaviorSubject<AdaptiveTask[]> = new BehaviorSubject([]);
    ...
    abstract addTask(): Observable<AdaptiveTask>;

    abstract cloneTask(): Observable<AdaptiveTask>;

    abstract deleteTask(): Observable<any>;

    abstract onActiveTaskChanged(task: AdaptiveTask): void;
