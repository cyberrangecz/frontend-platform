...
export class RunningTrainingRunService {
    ...
    protected activeLevelSubject$: BehaviorSubject<Level> =
        new BehaviorSubject<Level>(undefined);
    activeLevel$: Observable<Level> = this.activeLevelSubject$
        .asObservable()
        .pipe(skipWhile((level) => level === undefined || level === null));
    protected backtrackedLevelSubject$: BehaviorSubject<Level> =
        new BehaviorSubject<Level>(undefined);
    backtrackedLevel$: Observable<Level> = this.backtrackedLevelSubject$
        .asObservable()
        .pipe(skipWhile((level) => level === undefined || level === null));
    protected isCurrentLevelAnsweredSubject$: BehaviorSubject<boolean> =
        new BehaviorSubject<boolean>(false);
    isCurrentLevelAnswered$: Observable<boolean> =
        this.isCurrentLevelAnsweredSubject$.asObservable();
