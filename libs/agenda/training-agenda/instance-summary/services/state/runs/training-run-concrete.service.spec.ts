...
import {SandboxAllocationUnitsApi, SandboxInstanceApi} from 'libs/api/sandbox-api/src';
import {TrainingInstanceApi, TrainingRunApi} from 'libs/api/training-api/src';
