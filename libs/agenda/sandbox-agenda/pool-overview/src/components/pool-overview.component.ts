...
import { PoolTable } from 'libs/agenda/sandbox-agenda/pool-overview/src/model/pool-table';
import { SandboxNavigator } from '@crczp/sandbox-agenda';
import { DefaultPaginationService } from '@crczp/sandbox-agenda/internal';
...
import { SandboxInstanceService } from 'libs/agenda/sandbox-agenda/pool-detail/src';
