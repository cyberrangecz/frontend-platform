...
import { SandboxInstanceService } from 'libs/agenda/sandbox-agenda/pool-detail/src/services/state/sandbox-instance/sandbox-instance.service';
import { SandboxAllocationUnitsService } from 'libs/agenda/sandbox-agenda/pool-detail/src/services/state/sandbox-allocation-unit/sandbox-allocation-units.service';
import { AllocateVariableSandboxesDialogComponent } from 'libs/agenda/sandbox-agenda/pool-detail/src/components/allocate-variable-sandboxes/allocate-variable-sandboxes-dialog.component';
import { AllocateVariableSandboxesDialogResult } from 'libs/agenda/sandbox-agenda/pool-detail/src/components/allocate-variable-sandboxes/allocateVariableSandboxesDialogResult';
