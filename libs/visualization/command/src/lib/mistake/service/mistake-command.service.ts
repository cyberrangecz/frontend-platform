...
export class MistakeCommandService {
    ...
    private selectedTrainingRunsSubject$: BehaviorSubject<ResourceSelect[]> = new BehaviorSubject([]);
    selectedTrainingRuns$: Observable<ResourceSelect[]> = this.selectedTrainingRunsSubject$.asObservable();
