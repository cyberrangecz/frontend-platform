import {AbstractPhaseTypeEnum, AdaptiveTask, Phase, TrainingPhase, TrainingUser} from '@crczp/training-model';
import {
    QuestionnairePhaseTask
} from "../../transition-visualization/model/phase/questionnaire-phase/questionnaire-phase-task";
import {
    AccessPhaseTask,
