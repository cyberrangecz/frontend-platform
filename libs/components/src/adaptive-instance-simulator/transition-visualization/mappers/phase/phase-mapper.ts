...
export class PhaseMapper {
    static fromDTO(dto: AbstractPhaseDTO): AdaptiveVisualizationPhase {
        let phase!: AdaptiveVisualizationPhase;
    ...
    static fromDTOs(dtos: AbstractPhaseDTO[]): AdaptiveVisualizationPhase[] {
