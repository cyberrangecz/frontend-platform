...
export class InstanceModelSimulatorComponent implements OnInit, OnDestroy {
    ...
    private instanceSimulatorDataSubject$: BehaviorSubject<InstanceModelSimulator> =
        new BehaviorSubject(null);
    instanceSimulatorData$: Observable<InstanceModelSimulator> =
        this.instanceSimulatorDataSubject$.asObservable();

    private disableGenerateSubject$: BehaviorSubject<boolean> =
        new BehaviorSubject(true);
    disableGenerate$: Observable<boolean> =
        this.disableGenerateSubject$.asObservable();
