...
import { AdaptiveTransitionVisualizationApi } from '@crczp/visualization-api';
...
export class AdaptiveTransitionVisualizationService {
    ...
    private visualizationDataSubject$: BehaviorSubject<TransitionVisualizationData> =
        new BehaviorSubject<TransitionVisualizationData>(
            null as unknown as TransitionVisualizationData
        );
