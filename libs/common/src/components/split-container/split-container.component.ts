...
import { sum } from 'd3';
import { DividerPositionSynchronizerService } from '../../service/synchronization/divider-position/divider-position-synchronizer.service';
...
export class SplitContainerComponent implements AfterViewInit {
    ...
    onResize(event: any): void {
        if (
            this.disableAtWindowWidth &&
            event.target.innerWidth < this.disableAtWindowWidth
        ) {
