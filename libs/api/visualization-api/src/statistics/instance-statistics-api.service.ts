...
export class InstanceStatisticsApiService {
    ...
    private readonly trainingInstancesSubject$: BehaviorSubject<
        TrainingInstanceStatistics[]
    > = new BehaviorSubject([]);
    readonly trainingInstance$: Observable<TrainingInstanceStatistics[]> =
        this.trainingInstancesSubject$.asObservable();
    ...
    getAll(definitionId: number): Observable<TrainingInstanceStatistics[]> {
        return this.http
            ...
            .pipe(
                ...
                tap((instances) =>
                    this.trainingInstancesSubject$.next(instances)
                )
            );
    }
