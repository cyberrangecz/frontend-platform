...
export abstract class CommonCommandApi {
    ...
    constructor(
        ...
        this.adaptiveVisualizationsEndpoint = `${this.config.adaptiveBasePath}/visualizations`;
        this.instanceEndpoint = `${this.config.trainingBasePath}/training-instances`;
        this.adaptiveInstanceEndpoint = `${this.config.adaptiveBasePath}/training-instances`;
        this.cheatingDetectionEndpoint = `${this.config.trainingBasePath}/cheating-detections`;
    }
