...
export abstract class AdaptiveTrainingDefinitionApi {
    ...
    abstract createInfoPhase(
        trainingDefinitionId: number,
    ): Observable<InfoPhase>;

    abstract createTrainingPhase(
        trainingDefinitionId: number,
    ): Observable<TrainingPhase>;

    abstract createAccessPhase(
        trainingDefinitionId: number,
    ): Observable<AccessPhase>;

    abstract createAdaptiveQuestionnairePhase(
        trainingDefinitionId: number,
    ): Observable<QuestionnairePhase>;

    abstract createGeneralQuestionnairePhase(
        trainingDefinitionId: number,
    ): Observable<QuestionnairePhase>;
    ...
    abstract deletePhase(
        trainingDefinitionId: number,
        phaseId: number,
    ): Observable<any>;

    abstract updatePhases(
        trainingDefinitionId: number,
        phases: Phase[],
    ): Observable<any>;

    abstract updateTrainingPhase(
        trainingDefinitionId: number,
    ...
    abstract updateInfoPhase(
        trainingDefinitionId: number,
        infoPhase: InfoPhase,
    ): Observable<any>;

    abstract movePhaseTo(
        trainingDefinitionId: number,
        phaseId: number,
        newPosition: number,
    ): Observable<any>;
