...
import { AdaptiveTrainingInstanceApi } from './adaptive-instance-api.service';
 ...
 */
@Injectable()
export class AdaptiveInstanceDefaultApi extends AdaptiveTrainingInstanceApi {
    ...
    constructor() {
        ...
        const basePath = inject(PortalConfig).basePaths.adaptiveTraining;
     ...
     * @param expectedErrorCodes list of expected error codes that should not trigger error handling
     */
    delete(
        trainingInstanceId: number,
        force: boolean,
